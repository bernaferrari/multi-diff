import { MAX_LANES, laneIdAt, laneTitle } from "../lanes/lanes";
...
const STORED_LANE_MARKER_STYLES = ["letters", "bars"] satisfies LaneMarkerStyle[];

export function restoreStoredWorkbenchState(value: unknown): RestoredWorkbenchState | null {
...
function restorePane(pane: unknown, index: number): Pane {
  ...
  return {
    ...
    filename: typeof savedPane.filename === "string" ? savedPane.filename : undefined,
  };
}
