...
import { useRowViewportScroll } from "../navigation/use-row-viewport-scroll";
import { getViewportLayoutState } from "../workbench/viewport-layout-state";
import { ViewportLaneStack, type ViewportLaneStackActions } from "../workbench/viewport-lane-stack";
import type {
  DiffRenderSettings,
