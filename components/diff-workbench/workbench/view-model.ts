import { buildFileRows } from "../rendering/diff-data";
import { buildPaneViewModel, type DisplayedPaneView } from "../rendering/pane-view-model";
import {
  getDisplayedPanes,
  getSharedFileCount,
  getVisibleFocusFile,
...
import type { FileRow, LaneId, PaneView, ParsedPane } from "../shared/types";
...
export function buildWorkbenchViewModel({
  ...
  const { fileRows, hiddenFileRows } = partitionFileRows(allFileRows, hiddenFiles);
